...
class PluginGeneratorConnector {
    ...
    public function install_plugin($request) {
        ...
        $delete_first = isset($params['delete_first']) ? (bool)$params['delete_first'] : false;
        ...
        // If delete_first is true and plugin_slug is provided, delete the existing plugin first
        if ($delete_first && !empty($plugin_slug)) {
