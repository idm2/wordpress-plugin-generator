...
app.post('/preview-plugin', async (req, res) => {
...
app.post('/delete-preview-site', async (req, res) => {
...
app.post('/export-plugin', (req, res) => {
  const { pluginName, code } = req.body;
  if (!pluginName || !code) {
...
// Add this new endpoint to check site status
